...
def configure_leader(node_name, members_for_group, parameters, node_metadata):
 ...
 # FUNZIONE UTILITY per generare anche ssh in un solo posto       
def generate_ssh_keys():
    ssh_dir = os.path.join("shared", "ssh")
...
if __name__ == "__main__":
    try:
        ...
        generate_config(config_path, ["SQL_INJECTION", "XSS_ATTACK", "PATH_TRAVERSAL", "BRUTE_FORCE"])
