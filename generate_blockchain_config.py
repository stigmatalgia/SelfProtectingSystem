...
def generate_blockchain_configurations():
    ...
    # Fix: Usa il percorso corretto per estrarre e rimuovere il file .tar
...
def generate_config(configurations_path: str, parameters: list[str]):
    ...
    # Fix: Aggiornato per riflettere il nuovo percorso in lab/quorum
...
def generate_ssh_keys():
    # Fix: Aggiornato per usare il path specifico di quorum
